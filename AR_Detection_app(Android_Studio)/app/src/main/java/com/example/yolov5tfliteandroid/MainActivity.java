...
import android.widget.Button; //添加按钮
...
//        });
    ...
    //按钮02点击  持续显示视图或文本提示较长时间
    public void click(View view) {
        //Toast.makeText(MainActivity.this,"Point the camera at the Object you want to know about. Then it will tell you what it is!",Toast.LENGTH_LONG).show();
        //gravity:显示的位置，上下左右，
        Toast toast = Toast.makeText(MainActivity.this,"Point the camera at the Object you want to know about. Then it will tell you what it is!",Toast.LENGTH_LONG);
        toast.setGravity(Gravity.LEFT|Gravity.TOP,20,500);
        toast.show();
